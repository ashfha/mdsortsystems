...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/70 bg-background/80 shadow-sm shadow-primary/5 backdrop-blur-xl">
      ...
      {open && (
        <div className="md:hidden border-b border-border bg-background/95 px-4 pb-4 shadow-lg backdrop-blur-xl space-y-3">
          {links.map((l) => (
