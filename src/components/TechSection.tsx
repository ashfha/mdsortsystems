...
const TechSection = () => (
  <section id="tech" className="relative overflow-hidden py-20 md:py-28 bg-card/80">
        ...
        <div className="space-y-8">
          {steps.map((s) => (
            <div key={s.num} className="flex gap-5">
              <div className="flex-shrink-0 h-14 w-14 rounded-full bg-accent/10 flex items-center justify-center border-2 border-accent/20 shadow-sm shadow-accent/10">
